...
- 如果配置中的`storage.t`大于1，操作命令需要执行t次，t-n密码需要使用专门工具生成，不可以任意创建。工具源码[sinohope-mpc-node/releases](https://github.com/sinohope/sinohope-mpc-node/releases)https://github.com/sinohope/shamir-pasasword
