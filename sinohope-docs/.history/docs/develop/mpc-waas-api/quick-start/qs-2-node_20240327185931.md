...
| curInputId  | string |  Detailed data of utxo transactions, including vin, vout                      |
| extraData   | json   |  Detailed data of utxo transactions, including vin, voututxo交易的详细数据，包括vin,vout         |
