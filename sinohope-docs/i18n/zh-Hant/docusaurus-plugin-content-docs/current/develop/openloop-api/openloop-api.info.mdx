...
<span className={"theme-doc-version-badge badge badge--secondary"}>Version: 0.9.12</span>
...
<div><table><tbody><tr><th>Security Scheme Type:</th><td>apiKey</td></tr><tr><th>Header parameter name:</th><td>BIZ-API-KEY</td></tr></tbody></table></div></TabItem><TabItem label={"API Key: ApiNonce"} value={"ApiNonce"}>

A nonce value (timestamp) that is included in the data to be signed.

<div><table><tbody><tr><th>Security Scheme Type:</th><td>apiKey</td></tr><tr><th>Header parameter name:</th><td>BIZ-API-NONCE</td></tr></tbody></table></div></TabItem><TabItem label={"API Key: ApiSig"} value={"ApiSig"}>
